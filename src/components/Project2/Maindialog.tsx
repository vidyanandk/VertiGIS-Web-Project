...
export default function MainDialog(props: LayoutElementProperties<LayerListProjectModel>) {
    ...
    useWatchAndRerender(model,["maindialogmodel", "propertiesModel", "stylemodel", "selectedLayer"]);
    ...
    return (
        <LayoutElement {...other}>
            <Modal open={model.maindialogmodel} onClose={()=> {model.maindialogmodel = false;}}>
                <div
                    style={{
                        padding: "2rem",
                        width: "300px",
